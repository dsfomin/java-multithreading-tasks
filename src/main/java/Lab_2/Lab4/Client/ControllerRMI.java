...
public class ControllerRMI {
    ...
    private final ServerRMI serverRMI = (ServerRMI) Naming.lookup(URL);
    ...
    public ControllerRMI() throws RemoteException, NotBoundException, MalformedURLException {
    }
    ...
    public void addManufacturer(ActionEvent actionEvent) {
        ...
        submit.setOnAction(e -> {
            if ((name.getText() != null && !name.getText().isEmpty()) && (id.getText() != null && !id.getText().isEmpty())) {
                ...
                try {
                    int response = serverRMI.addManufacturer(manufacturer);
        ...
        submit.setOnAction(e -> {
            if ((name.getText() != null && !name.getText().isEmpty()) &&
                ...
                try {
                    ...
                    int response = serverRMI.addCarBrandToManufacturer(brand, manufacturerId.getText());
    ...
    public void deleteManufacturer(ActionEvent actionEvent) {
        ...
        submit.setOnAction(e -> {
            if (id.getText() != null && !id.getText().isEmpty()) {
                try {
                    int response = serverRMI.deleteManufacturer(id.getText());
    ...
    public void getManufacturers(ActionEvent actionEvent) {
        ...
        try {
            manufacturers = serverRMI.getManufacturers();
        } catch (Exception e) {
